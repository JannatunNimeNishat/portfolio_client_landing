...
const Footer = () => {
    return (
        <div className=" bg-[#111a28] text-white py-8 ">
            <div className="flex items-center justify-center lg:justify-between lg:w-8/12 mx-auto ">

            <div className="flex items-center text-sm lg:text-normal gap-2 lg:gap-4">
